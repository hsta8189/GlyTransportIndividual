function [t,z] = make_equilib_glyt1(z0, k, kinv, c, tau, tspan, fix_GlyE)
...
dzdt(9) = 0; % intracellular sodium
dzdt(10) = 0;%J_Na_e; %extracellular sodium --fixed
dzdt(11) =  0; % intracellular chloride
dzdt(12) = 0; % extracellular chloride --fixed
dzdt(13) =  0; % intracellular glycine
dzdt(14) =  0;
end
end